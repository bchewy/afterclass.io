          ...
          >
            {filterOptions.map((item, j) => (
              <ToggleGroupItem
                ...
                className="text-foreground focus-ring hover:bg-accent data-[state=on]:bg-primary data-[state=on]:text-primary-foreground inline-flex h-10 flex-shrink-0 items-center justify-center border border-border px-5 py-1 text-base transition-colors"
              >
                {item.label}
              </ToggleGroupItem>
            ))}
