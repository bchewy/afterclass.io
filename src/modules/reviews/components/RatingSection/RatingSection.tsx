...
export const RatingSection = ({
  ...
  return (
    <div
      className="relative flex w-full flex-col items-start gap-5 border-b border-border p-6"
...
const RatingSectionSkeleton = () => {
  return (
    <div className="relative flex w-full flex-col items-start gap-5 border-b border-border p-6">
      <div className="flex w-full items-center gap-10 rounded-none">
        <div className="flex items-center gap-3 rounded-none">
          <HeartIcon className="size-6" />
