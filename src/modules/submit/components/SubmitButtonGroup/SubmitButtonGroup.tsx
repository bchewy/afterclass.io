...
export const SubmitButtonGroup = ({ isLoading }: { isLoading: boolean }) => {
  ...
  return (
    <div className="border-border inline-flex h-10 shrink-0 items-center justify-center border">
      <Button
        type="submit"
        className="flex h-full content-center items-center gap-2 self-stretch rounded-none border-r border-border pr-3 pl-4"
        disabled={isLoading}
