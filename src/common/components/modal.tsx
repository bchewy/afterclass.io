...
const ModalContent = ({
  ...
  return (
    <Portal>
      <Overlay className="bg-background/80 fixed inset-0 z-50 flex justify-center overflow-y-auto p-4 data-[state=closed]:animate-[dialog-overlay-hide_200ms] data-[state=open]:animate-[dialog-overlay-show_200ms] sm:p-10">
        <Content
          className={cn(
            "border-border bg-background text-foreground relative m-auto flex h-fit w-full max-w-[720px] flex-col overflow-hidden rounded-sm border py-5 sm:py-8",
            className,
          )}
